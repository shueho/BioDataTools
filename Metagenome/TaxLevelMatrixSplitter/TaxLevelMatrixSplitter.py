...
#
# This script extracts species abundance data for various taxonomic ranks from the species abundance table and constructs corresponding abundance matrices.
